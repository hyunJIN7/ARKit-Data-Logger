...
iosTextFileDir = 'stray/o_z/odometry.csv'; % timestamp framenum x y z qx qy qz q
...
%% StrayScanner 
ARCorePoseData = readtable(iosTextFileDir);
ARCorePoseTime = ARCorePoseData.timestamp';
ARCorePoseTime = (ARCorePoseTime - ARCorePoseTime(1)) ./ nanoSecondToSecond;
ARCorePoseData = [ARCorePoseData.x,ARCorePoseData.y,ARCorePoseData.z, ARCorePoseData.qw , ARCorePoseData.qx, ARCorePoseData.qy,ARCorePoseData.qz];
